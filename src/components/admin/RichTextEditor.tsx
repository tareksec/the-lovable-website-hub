...
import { 
  ...
  Undo, Redo, Type, Highlighter, Trash2, ExternalLink
} from 'lucide-react';
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor="new-tab" className="text-sm text-gray-600">Open in new tab</label>
                </div>
            ...
            >
              ...
              {imageTab === 'upload' ? (
                  ...
                  >
                    {uploading ? (
                      <div className="space-y-3">
                        <div className="text-sm font-bold text-[#08735d]">Uploading... {uploadProgress}%</div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 uppercase mb-1">Alt Text (SEO)</label>
                    <input 
                      type="text" 
