...
export default function Navbar() {
  ...
  return (
    <>
      <header className={`bec-header-container ${hidden ? 'is-hidden' : ''} ${scrolled || !isHomePage ? 'is-scrolled' : ''}`}>
        <nav className="bec-nav" aria-label="Primary navigation">
          ...
          <Link to="/" className="bec-brand group" aria-label="Bangladesh Executive Chamber home" data-testid="link-brand-home">
          ...
          <Link to="/join" className="bec-join" data-testid="link-join-bec">Join BEC <ArrowRight aria-hidden="true" /></Link>
