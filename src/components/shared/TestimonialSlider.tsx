...
const testimonials: Testimonial[] = [
  {
    review: "BEC completely transformed our recruitment process. We hired 12 qualified professionals in just 6 weeks through their vast talent network. The team understood our requirements perfectly.",
    stars: 5,
  ...
  {
    review: "The one-on-one career consulting session completely changed my approach. I landed a senior executive role in just 3 months. Highly recommended for any professional looking to grow.",
    stars: 5,
  ...
  {
    review: "BEC's business consulting gave our startup the strategic clarity we desperately needed. Our revenue grew by 40% in the first quarter after implementing their recommendations.",
    stars: 5,
              ...
              <div className="relative z-10 min-h-[280px] md:min-h-[220px]">
                <AnimatePresence initial={false} custom={direction} mode="wait">
                  ...
                  >
                    ...
                    >
                      <img src={testimonial.photo} alt={testimonial.name} className="w-16 h-16 rounded-full border-2 border-[#c09643]" />
                      <div>
                        <h4 className="font-bold text-lg">{testimonial.name}</h4>
                        <p className="text-white/80 text-sm">{testimonial.designation}, {testimonial.company}</p>
                      </div>
                    </motion.div>
                  </motion.div>
                </AnimatePresence>
      ...
      <div className="bec-container px-4">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <Reveal>
              <div className="mb-12">
                <span className="bg-[#08735d]/10 text-[#08735d] text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-4 inline-block">
                  Our Testimonials
                </span>
                <h2 className="text-4xl font-extrabold text-[#14202d] mb-4">What Our Members Say</h2>
              ...
              <div className="relative min-h-[300px]">
                <AnimatePresence initial={false} custom={direction} mode="wait">
                  ...
                  >
                    ...
                    <blockquote className="text-lg md:text-xl text-[#14202d] font-medium leading-relaxed mb-8">
                      "{testimonial.review}"
                    </blockquote>
                    ...
                    <motion.div 
                      ...
                      className="flex items-center gap-4"
                    >
                      <img src={testimonial.photo} alt={testimonial.name} className="w-14 h-14 rounded-full border-2 border-[#08735d]/20" />
                      <div>
                        <h4 className="font-bold text-[#14202d]">{testimonial.name}</h4>
                        <p className="text-[#5d6870] text-sm">{testimonial.designation}, {testimonial.company}</p>
                      </div>
                    </motion.div>
                  </motion.div>
                </AnimatePresence>
