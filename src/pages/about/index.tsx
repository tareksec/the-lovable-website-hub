            ...
            <div className="w-full md:w-1/2">
              <Reveal direction="right">
                ...
                <p className="text-[15px] text-[#6b7280] leading-[1.75]">
                  Our vision is to build a professional ecosystem where growth is accessible to all,
              ...
              <Reveal direction="left">
                <div className="relative rounded-[24px] overflow-hidden shadow-bec-soft border border-gray-100/60 hover:shadow-bec-soft-hover transition-all duration-300">
                  <motion.img
                    ...
                    src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=1200&fm=webp"
        ...
        <div className="bec-container">
          <div className="grid md:grid-cols-2 gap-0 relative">
            <Reveal direction="left" delay={0.2} className="relative z-10 md:-mr-8 md:mt-12">
              <div className="bg-[#08735d] p-10 md:p-14 rounded-[32px] text-white shadow-bec-soft border border-[#08735d]/20">
                <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center mb-8">
                  <TrendingUp size={32} />
                </div>
                <h2 className="text-[32px] font-[800] mb-6 text-white tracking-tight">Our Mission</h2>
                <p className="text-white/80 leading-[1.75] text-[15px]">
                  To empower professionals across Bangladesh through specialized skill development,
                  strategic branding, and industry-wide collaboration.
                </p>
              </div>
            </Reveal>

            <Reveal direction="right" delay={0.4} className="relative z-0 md:-mt-4">
              <div className="bg-white p-10 md:p-14 rounded-[32px] text-[#14202d] shadow-bec-soft border border-gray-100/60">
                <div className="absolute top-0 right-0 p-8">
                  <div className="w-20 h-20 bg-[#c09643]/10 rounded-full flex items-center justify-center text-[#c09643]">
                    <Target size={40} />
                  </div>
                </div>
                <h2 className="text-[32px] font-[800] mb-6 pt-8 text-[#14202d] tracking-tight">Our Vision</h2>
                <p className="text-[#6b7280] leading-[1.75] text-[15px]">
                  To become the foremost professional hub in South Asia, recognized for producing
                  elite leaders and fostering sustainable corporate innovation.
                </p>
              </div>
            </Reveal>
          </div>
          ...
          <StaggerContainer>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {objectives.map((obj, i) => {
                ...
                return (
                  <StaggerItem key={i}>
                    <div className="group relative p-8 bg-white rounded-[24px] shadow-bec-soft border border-gray-100/60 transition-all duration-300 hover:shadow-bec-soft-hover hover:-translate-y-2">
                      ...
                      <h3 className="text-[18px] font-[800] text-[#14202d] mb-3">{obj.title}</h3>
                ...
                <Reveal key={i} direction={i % 2 === 0 ? "left" : "right"} delay={i * 0.2}>
                  ...
                  >
                    ...
                    <div className="w-full md:w-1/2 pt-2 md:pt-0 pl-16 md:pl-0">
                      <div
                        className={`p-8 bg-white rounded-2xl shadow-xl border border-gray-50 ${i % 2 === 0 ? "md:text-right" : "md:text-left"}`}
                      >
                        <div className="text-[36px] font-[800] text-[#08735d] mb-2 tracking-tight">
                          {m.year}
                        </div>
                        <p className="text-gray-600 font-medium text-lg">{m.title}</p>
                      </div>
                    </div>
        ...
        <div className="bec-container">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-xl mx-auto mt-4">
              The visionary professionals driving Bangladesh's premier executive network.
            </p>
          </div>
            ...
            {loading ? (
              ...
              <div className="col-span-full flex flex-col items-center justify-center py-20 bg-white rounded-3xl border-2 border-dashed border-gray-200">
                ...
                <p className="text-gray-400 font-medium">
                  Leadership team data will appear here shortly.
                </p>
              </div>
            ) : (
              <StaggerContainer>
                  ...
                  {team.map((member) => (
                    <StaggerItem key={member.id}>
                      <div className="group h-[400px] [perspective:1000px]">
                        <motion.div className="relative w-full h-full transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] cursor-pointer">
                          {/* Front */}
                          <div className="absolute inset-0 [backface-visibility:hidden] rounded-[24px] overflow-hidden bg-white shadow-bec-soft border border-gray-100/60 flex flex-col">
                            ...
                            <div className="h-1/3 p-6 flex flex-col items-center justify-center text-center">
                              <h3 className="text-[18px] font-[800] text-[#14202d] mb-1">
                                {member.name}
                              </h3>
                              <p className="text-[#08735d] text-[14px] font-[600]">
                                {member.designation}
                              </p>
                            </div>
                          </div>
                          ...
                          {/* Back */}
                          <div className="absolute inset-0 [backface-visibility:hidden] [transform:rotateY(180deg)] rounded-[24px] bg-[#08735d] p-8 flex flex-col items-center justify-center text-center text-white shadow-bec-soft-hover border border-[#08735d]/20">
                            <h3 className="text-xl font-[800] mb-2">{member.name}</h3>
                            <div className="w-10 h-1 bg-[#c09643] mb-6" />
                            <p className="text-sm text-white/80 leading-relaxed mb-8">
                              Passionate leader dedicated to fostering a professional ecosystem in
                              Bangladesh through innovation and strategic growth.
                            </p>
                            {member.linkedinUrl && (
                              <a
