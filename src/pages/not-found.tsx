  ...
  return (
    <PageTransition className="flex min-h-[70vh] w-full items-center justify-center bg-[#fbfcfb] px-4 py-24 text-center relative overflow-hidden">
      ...
      <div className="mx-auto max-w-lg relative z-10">
        ...
        <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#c09643]">
          Error 404
        </p>
        <h1 className="mb-4 text-4xl font-extrabold text-[#14202d]">
          This page isn’t part of the Chamber
        </h1>
        <p className="mb-10 text-lg text-gray-600">
          The page you’re looking for doesn’t exist or has moved. Explore our services, events, or
          get in touch with the Bangladesh Executive Chamber team.
        </p>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-6 text-sm font-bold text-[#08735d]">
          <Link to="/about" className="bec-nav-link">
            About Us
          </Link>
          <Link to="/events" className="bec-nav-link">
            Events
          </Link>
          <Link to="/resources" className="bec-nav-link">
            Resources
          </Link>
          <Link to="/contact" className="bec-nav-link">
            Contact Us
          </Link>
        </div>
      </div>
