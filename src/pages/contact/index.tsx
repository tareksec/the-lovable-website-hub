      ...
      <section className="bec-section relative overflow-hidden bg-[#fbfcfb]">
        <div
          ...
          style={{
            top: "-150px",
            right: "-100px",
            background: "radial-gradient(circle, rgba(192, 150, 67, 0.05) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="bec-container">
          <div className="bec-contact-layout">
            ...
            <div className="bec-contact-info-col">
              ...
              <motion.div className="bec-info-card group cursor-pointer bg-white rounded-[24px] p-6 shadow-bec-soft border border-gray-100/60 hover:shadow-bec-soft-hover transition-all duration-300" whileHover={{ y: -5 }}>
                <motion.div className="info-icon text-[#08735d] bg-[#08735d]/10 w-12 h-12 rounded-full flex items-center justify-center shrink-0 transition-colors group-hover:bg-[#08735d] group-hover:text-white" whileHover={{ scale: 1.1, rotate: 5 }}>
                  <MapPin />
                </motion.div>
                <div>
                  <h4 className="group-hover:text-[#08735d] transition-colors font-[800] text-[#14202d] text-lg mb-1">Location</h4>
                  <p className="text-[#6b7280]">Dhaka, Bangladesh</p>
                </div>
              </motion.div>
              ...
              <motion.div className="bec-info-card group cursor-pointer bg-white rounded-[24px] p-6 shadow-bec-soft border border-gray-100/60 hover:shadow-bec-soft-hover transition-all duration-300" whileHover={{ y: -5 }}>
                ...
                <div>
                  <h4 className="group-hover:text-[#08735d] transition-colors font-[800] text-[#14202d] text-lg mb-1">Email Us</h4>
                  <p className="text-[#6b7280]">info@b-e-c.org</p>
                </div>
              </motion.div>
              ...
              <motion.div className="bec-info-card group cursor-pointer bg-white rounded-[24px] p-6 shadow-bec-soft border border-gray-100/60 hover:shadow-bec-soft-hover transition-all duration-300" whileHover={{ y: -5 }}>
                ...
                <div>
                  <h4 className="group-hover:text-[#08735d] transition-colors font-[800] text-[#14202d] text-lg mb-1">LinkedIn</h4>
                  <a
                    href="https://www.linkedin.com/company/bangladesh-executive-chamber/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#08735d] font-[700] hover:underline flex items-center gap-1 group/link"
                  >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bec-form-card p-10 md:p-14 bg-white rounded-[32px] shadow-bec-soft border border-gray-100/60 hover:shadow-bec-soft-hover transition-all duration-500">
                <h3 className="text-[28px] font-[800] text-[#14202d] tracking-tight mb-2">Send us a Message</h3>
                <p className="text-[#6b7280] leading-[1.6] mb-8">
                ...
                <form onSubmit={handleSubmit} className="bec-form space-y-6">
                  <div className="bec-floating-label-group">
                    ...
                    />
                    <label className="bec-floating-label">
                      Full Name <span className="bec-required-asterisk">*</span>
                    </label>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bec-floating-label-group">
                      ...
                      />
                      <label className="bec-floating-label">
                        Email Address <span className="bec-required-asterisk">*</span>
                      </label>
                    </div>
                    <div className="bec-floating-label-group">
                      <input
                  ...
                  <div className="bec-floating-label-group">
                    ...
                    />
                    <label className="bec-floating-label">
                      Subject <span className="bec-required-asterisk">*</span>
                    </label>
                  </div>
                  ...
                  <div className="bec-floating-label-group">
                    ...
                    />
                    <label className="bec-floating-label">
                      Message <span className="bec-required-asterisk">*</span>
                    </label>
                  </div>
