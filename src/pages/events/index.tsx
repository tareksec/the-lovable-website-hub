...
import { Calendar, MapPin, Clock, X, Check, ArrowRight, User, Mail, Phone, Info } from 'lucide-react';
  ...
  return (
    <PageTransition className="bec-events-page">
      <section className="bec-section relative overflow-hidden bg-[#fbfcfb]">
        <div className="bec-orb" style={{ top: '-200px', left: '50%', transform: 'translateX(-50%)' }} />
        <div className="bec-dot-pattern" style={{ bottom: '20px', right: '40px' }} />
      ...
      <section className="bec-section bg-white">
        <div className="bec-container">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-8">
            <h2 className="text-[32px] md:text-[40px] font-[800] text-[#14202d]">Event Calendar</h2>
          ...
          {loading ? (
            ...
            <div className="py-24 text-center border-4 border-dashed border-[#edf6f2] rounded-[40px]">
              ...
              <h3 className="text-xl font-bold text-[#14202d] mb-2">No events found</h3>
              <p className="text-[#5d6870]">Check back later for new workshops and sessions.</p>
            </div>
          ) : (
                ...
                {filteredEvents.map((event) => {
                  ...
                  return (
                    <Reveal key={event.id} y={20}>
                      <div className={`bec-card-hover bg-white rounded-[32px] overflow-hidden border border-[#edf6f2] shadow-xl group h-full flex flex-col ${isPast ? 'bec-past-event-card opacity-80' : ''}`}>
                        <div className="relative h-48 overflow-hidden bg-[#edf6f2]">
                          ...
                          {isPast && (
                            <div className="bec-past-event-overlay">
                              <div className="text-white text-center p-6">
                                <div className="w-12 h-12 rounded-full border-2 border-white/30 flex items-center justify-center mx-auto mb-4">
                                  <Check size={24} />
                                </div>
                                <span className="font-bold uppercase tracking-widest text-xs">Event Concluded</span>
                              </div>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="p-8 flex-1 flex flex-col">
                          <h3 className="text-xl font-bold text-[#14202d] mb-4 group-hover:text-[#08735d] transition-colors">{event.title}</h3>
                ...
                <AnimatePresence mode="wait">
                  {modalStep === 1 && (
                    ...
                    >
                      <div>
                        ...
                        <h3 className="text-[24px] font-[800] text-[#14202d] mt-2">{selectedEvent.title}</h3>
                      </div>
                      <div className="bg-[#f9fafb] p-6 rounded-3xl space-y-4">
                        <div className="flex items-start gap-4">
                          <Info size={20} className="text-[#08735d] mt-1 shrink-0" />
                          <p className="text-sm text-[#5d6870] leading-relaxed">{selectedEvent.description}</p>
                        </div>
                  ...
                  {modalStep === 2 && (
                    ...
                    >
                      <div>
                        ...
                        <h3 className="text-[24px] font-[800] text-[#14202d] mt-2 mb-8">Registration Form</h3>
                      </div>
                      ...
                      <form onSubmit={handleRegister} className="space-y-6">
                        ...
                        <div className="flex gap-4 pt-4">
                          <button 
                            ...
                            className="flex-1 bg-gray-100 text-[#14202d] py-[16px] rounded-lg font-[700] hover:bg-gray-200 transition-all text-[15px]"
                          >
                            Back
                          </button>
                          <button 
                  ...
                  {modalStep === 3 && (
                    ...
                    >
                      ...
                      <h3 className="text-[32px] font-[800] text-[#14202d] mb-4">You're In!</h3>
                      <p className="text-[#6b7280] text-[15px] leading-relaxed mb-10">
                        Thank you for registering. We've sent a confirmation email to <span className="text-[#08735d] font-bold">{email}</span> with all the session details.
                      </p>
