...
export default function Reviews() {
  ...
  return (
    <PageTransition className="bec-reviews-page">
      <section className="bec-section relative overflow-hidden bg-bec-offwhite">
          ...
          <div className="flex flex-col md:flex-row items-center gap-16 mb-20">
            <div className="w-full md:w-1/2">
              <Reveal direction="right">
                ...
                <h1 className="text-4xl md:text-6xl font-extrabold text-bec-navy leading-tight mb-6">
                  Reviews & <span className="text-bec-emerald">Testimonials</span>
                </h1>
            ...
            <div className="w-full md:w-1/2 relative">
              <Reveal direction="left">
                <div className="relative rounded-[24px] overflow-hidden shadow-bec-soft border border-gray-100/60 hover:shadow-bec-soft-hover transition-all">
                  <img
                    loading="lazy"
        ...
        <div className="bec-container">
          ...
          {!loading && !error && filteredReviews.length > 0 && filter === "All" && (
            <Reveal y={40} className="mb-20">
              <div className="bg-gradient-to-br from-bec-navy to-[#0a111a] text-white p-12 md:p-20 rounded-[40px] shadow-bec-soft border border-white/10 relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-[#c09643] font-medium">
                        {[filteredReviews[0]?.designation, filteredReviews[0]?.company]
                          .filter(Boolean)
                          .join(", ")}
                      </p>
                    </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
                ...
                <div className="bec-masonry-grid">
                  {filteredReviews.slice(filter === "All" ? 1 : 0).map((review, idx) => (
                    <Reveal key={review.id} y={30} delay={idx * 0.1} className="bec-masonry-item">
                      <div className="p-8 bg-white rounded-3xl border border-gray-100/60 shadow-bec-soft hover:shadow-bec-soft-hover transition-all group">
                        <div className="mb-6">
                          <AnimatedStars rating={review.rating} />
                        </div>
                        <p className="text-bec-navy leading-relaxed mb-8 italic">
                          "{review.message}"
                        </p>
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <h4 className="font-bold text-bec-navy text-sm">{review.name}</h4>
            ...
            <div className="w-full lg:w-[400px]">
              <div className="bg-white p-10 rounded-[32px] shadow-bec-soft border border-gray-100/60 sticky top-24">
                <h3 className="text-2xl font-black text-[#14202d] mb-2">Share Your Story</h3>
                <p className="text-sm text-[#5d6870] mb-8">
                  Help others by sharing your professional experience with BEC.
                </p>

                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="mb-8">
                    <label className="block text-xs font-black text-[#14202d] uppercase tracking-widest mb-4">
                      Your Rating
                    </label>
                  ...
                  <div className="bec-floating-label-group">
                    ...
                    />
                    <label className="bec-floating-label">
                      Review Message <span className="bec-required-asterisk">*</span>
                    </label>
                  </div>
                  ...
                  <button type="submit" className="bec-button bec-primary w-full" disabled={submitting}>
                    {submitting ? (
                      <>
                        <motion.div
                          animate={{ rotate: 360 }}
